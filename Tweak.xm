...
-(UIImageView *)m_lineView2{
    ...
    if (!imageView) {
        UIImageView *m_lineView = MSHookIvar<UIImageView *>(self, "m_lineView");
...
- (void)showWithItemData:(id)arg1 tipPoint:(struct CGPoint)arg2{
    %orig(arg1,arg2);
    // 原始代码中有DKHelperConfig.timeLineForwardEnable判断，这里去掉判断直接生效
