...
- (void)forwordTimeLine:(id)arg1 {
    ...
    if (self.navigationController) {
        ...
        if (navController) {
            ...
            [((UINavigationController *)[[UIApplication sharedApplication] keyWindow].rootViewController) pushViewController:forwardVC animated:YES];
        }
    }
}
